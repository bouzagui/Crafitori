    ...
    <div className="font-Poppins flex justify-center items-center min-h-screen bg-cover bg-center object-cover bg-no-repeat " style={{ backgroundImage: `url(${bgImage})` }}>
      ...
      <div>
        <div className="bg-blue-100 border border-slale-400 rounded-[64px] p-16 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-80 relative ">
          <h2 className="text-4xl font-bold text-center text-primaryBlack mb-16">Create An Account!</h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="w-full mb-4 rounded-full bg-primaryBlack text-white font-semibold text-xl py-3 hover:bg-white hover:text-primaryBlack transition-colors duration-300 ">Sign Up</button>
