...
const ConfEmail = () => {
  ...
  return (
    <div className='bg-primaryBlack font-Poppins flex justify-center items-center min-h-screen bg-cover bg-center object-cover bg-no-repeat'>
        ...
        <div className="conf-container">
          <form onSubmit={handleSubmit}>
            ...
            <div className="conf-btn">
              <button type="submit" className="w-full mb-4 rounded-full bg-primaryBlack text-white font-semibold text-xl py-3 hover:bg-white hover:text-primaryBlack transition-colors duration-300">Verify</button>
