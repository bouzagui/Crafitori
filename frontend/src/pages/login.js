...
const Login = () => {
  ...
  return (
    ...
    <div className="font-Poppins flex justify-center items-center min-h-screen bg-cover bg-center object-cover bg-no-repeat " style={{ backgroundImage: `url(${bgImage})` }}>
      ...
      <div>
        <div className="bg-blue-100 border border-slale-400 rounded-[64px] p-32 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-80 relative ">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="w-full mb-4 rounded-full bg-primaryBlack text-white font-semibold text-xl py-3 hover:bg-white hover:text-primaryBlack transition-colors duration-300 ">Login</button>
          ...
          <p className="text-center py-4 text-primaryBlack ">Don’t have an account?  <a href="/sign-up" className=" font-semibold hover:text-primaryBlackHover hover:underline">Sign Up</a>
          </p>
